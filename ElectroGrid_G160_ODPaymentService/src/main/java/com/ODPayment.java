...
public class ODPayment { 
 ...
 public String insertODPayment(String overdueCode, String totDueAmount, String noDueMonths, String months, String accNo, String suspend){ 
	 String output = ""; 
	 try{ 
	 ...
	 preparedStmt.setInt(4,Integer.parseInt( noDueMonths)); 
	 preparedStmt.setString(5, months);
	 preparedStmt.setString(6, accNo);
	 preparedStmt.setBoolean(7, Boolean.parseBoolean(suspend));
	 ...
	 String newOdps = readODPayment(); 
	 output = "{\"status\":\"success\", \"data\": \"" + newOdps + "\"}";
	 
	 } 
	 catch (Exception e){ 
		 output = "{\"status\":\"error\", \"data\": \"Error while Inserting the Overdue Payment.\"}";
...
//Reading Overdue Payments from the DB
	...
	public String readODPayment(){ 
	 ...
	 output += "<td><input name='btnUpdate' type='button' value='Update' "
			 + "class='btnUpdate btn btn-secondary' data-odpaymentid='" + ODPaymentID + "'></td>"
			 + "<td><input name='btnRemove' type='button' value='Remove' "
			 + "class='btnRemove btn btn-danger' data-odpaymentid='" + ODPaymentID + "'></td></tr>"; 
	...
	public String updateODPayment(String ID, String overdueCode, String totDueAmount, String noDueMonths, String months, String accNo, String suspend){ 
		 ...
		 output = "{\"status\":\"success\", \"data\": \"" + newOdps + "\"}";
			 ...
			 output = "{\"status\":\"error\", \"data\": \"Error while Updating the Overdue Payment.\"}";
		 System.err.println(e.getMessage());
		 } 
		 return output; 
		 } 
  ...
  public String deleteODPayment(String ODPaymentID){ 
		 ...
		 System.out.println(ODPaymentID);
		 // execute the statement
		 preparedStmt.execute(); 
		 con.close(); 
		 String newOdps = readODPayment(); 
		 output = "{\"status\":\"success\", \"data\": \"" + newOdps + "\"}";
			 ...
			 output = "{\"status\":\"error\", \"data\": \"Error while Deleting the Overdue Payment.\"}";
		 System.err.println(e.getMessage());
		 } 
		 return output; 
		 } 
